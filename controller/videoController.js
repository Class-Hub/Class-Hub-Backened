...
const uploadVideo = (req,res,next) => {
  console.log(req.userData)
    const videoDetails = new VideoDetails({
        ...
        video_path: 'http://localhost:'+ process.env.PORT + '/videos/' + req.file.filename.replace(/ /g, '_'),
        thumbnail_path: 'http://localhost:'+ process.env.PORT + '/thumbnail/' + req.userData.subject + '.jpg'
      });
      videoDetails
      .save()
      .then(result => {
